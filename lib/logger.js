...
Logger.prototype.log = function(statement, opts) {
    ...
    if (typeof statement === 'string' && this.ambientMeta) {
        statement = JSON.stringify(Object.assign(this.ambientMeta, {
            message: statement
        }));
    }
...
Logger.prototype.addProperty = function(key, value) {
    this.ambientMeta[key] = value;
};

Logger.prototype.removeProperty = function(key) {
    delete this.ambientMeta[key];
};
